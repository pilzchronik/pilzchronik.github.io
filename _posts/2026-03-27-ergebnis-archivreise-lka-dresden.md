...
<figure style="margin:24px 0;">
  <img src="{{ '/assets/images/kb23-taufe-abraham-1591.jpg' | relative_url }}"
       alt="Taufeintrag Abraham Pilz, August 1591, Kirchenbuch Dörnthal (KB 23)"
       style="max-width:100%; border:1px solid #ccc;">
  <figcaption style="font-size:0.85em; color:#666; margin-top:6px;">
    Taufeintrag Abraham Pilz, August 1591. Kirchenbuch Dörnthal (KB 23),
    EVLKS-Bestand Marienberg, LKA Dresden.
  </figcaption>
</figure>
...
<figure style="margin:24px 0;">
  <img src="{{ '/assets/images/kb23-tod-michael-piltz-1565.jpg' | relative_url }}"
       alt="Sterbeeintrag Michael Piltz der Ältere, 26. Juli 1565, Kirchenbuch Dörnthal (KB 23)"
       style="max-width:100%; border:1px solid #ccc;">
  <figcaption style="font-size:0.85em; color:#666; margin-top:6px;">
    Sterbeeintrag „der alte Michael Piltz", 26. Juli 1565. Kirchenbuch Dörnthal (KB 23),
    EVLKS-Bestand Marienberg, LKA Dresden.
  </figcaption>
</figure>
...
<figure style="margin:24px 0;">
  <img src="{{ '/assets/images/kb437-taufe-michael-piltz-1617.jpg' | relative_url }}"
       alt="Taufeintrag Michael Piltz, 13. Juli 1617, Taufbuch Olbernhau (KB 437)"
       style="max-width:100%; border:1px solid #ccc;">
  <figcaption style="font-size:0.85em; color:#666; margin-top:6px;">
    Taufeintrag Michael Piltz, 13. Juli 1617. Taufbuch Olbernhau (KB 437),
    EVLKS-Bestand Marienberg, LKA Dresden.
  </figcaption>
</figure>
